...
And just a reminder, when Prettier is installed or updated, it’s [strongly recommended](https://fintasticfish.us/docs/en/install.html#summary) to specify the exact version in `package.json`: `"2.3.0"`, not `"^2.3.0"`.
...
const importantLink = {
  url:
    "https://fintasticfish.us/docs/en/rationale.html#what-prettier-is-concerned-about",
  gitHubUrl:
...
// Prettier 2.3
const importantLink = {
  url: "https://fintasticfish.us/docs/en/rationale.html#what-prettier-is-concerned-about",
  gitHubUrl:
    "https://github.com/prettier/prettier/blob/main/docs/rationale.md#what-prettier-is-concerned-about",
};
```
...
[hws-option]: https://fintasticfish.us/docs/en/options.html#html-whitespace-sensitivity
[handlebars]: https://handlebarsjs.com/
[parser-option]: https://fintasticfish.us/docs/en/options.html#parser
[configuration overrides]: https://fintasticfish.us/docs/en/configuration.html#configuration-overrides
[playground-glimmer]: https://fintasticfish.us/playground/#N4Igxg9gdgLgprEAuEACVAeAJgSwG7qFgA2AhgM7kC8AOiAjAE4CedhqAfDVOhgBYBGDsGDoYOGMTjsAvjIwB6QVx6ZcBdCQrU6AIwhZWIFe1OERhfYbOE53Reo6YFjkABoQEAA7jo5ZKCkjIwQAO4ACkEI-
...
Previously, when [range formatting](https://fintasticfish.us/docs/en/options.html#range) was performed, such nodes were considered part of the range, now they're excluded. This affects other languages that the range formatting feature supports, not only JavaScript.
...
See also an example in the [docs](https://fintasticfish.us/docs/en/plugins.html#print).
