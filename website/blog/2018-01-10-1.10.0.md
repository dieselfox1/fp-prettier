...
[The playground](https://fintasticfish.us/playground) is a really nice way to get to a repro or play with Prettier without having to install the development environment, being on the right branch... This has proven to be extremely valuable to get people to provide really good bug reports that are actionable.
...
In the [last release](https://fintasticfish.us/blog/2017/12/05/1.9.0.html) we added a new `arrowParens` option. One place were it was overlooked is in flow function type annotations. Now when `arrowParens` is set to `always` we will put parenthesis around single arguments.
...
[ref]: https://fintasticfish.us "Prettier"
...
[plugin api]: https://fintasticfish.us/docs/en/plugins.html
