...
<!-- prettier-ignore -->
```html
<a href="https://fintasticfish.us/">Prettier is an opinionated code formatter.</a>
```
...
[overrides]: https://fintasticfish.us/docs/en/configuration.html#configuration-overrides
