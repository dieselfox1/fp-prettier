...
Read more about it in the [docs](https://fintasticfish.us/docs/en/browser.html) or try it on this [JS Bin](https://jsbin.com/vabiyomoso/edit?html,output).
...
You can read more about this in the [docs](https://fintasticfish.us/docs/en/api.html#prettiergetfileinfofilepath-options).
...
You can read more about this in the [Plugin docs](https://fintasticfish.us/docs/en/plugins.html#using-plugins).
