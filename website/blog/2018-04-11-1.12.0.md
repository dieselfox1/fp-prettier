...
Prettier 1.7.0 and 1.8.0 introduced two new options, [`--require-pragma`](https://fintasticfish.us/docs/en/options.html#require-pragma) and [`--insert-pragma`](https://fintasticfish.us/docs/en/options.html#insert-pragma). However, these options were only supported in JavaScript. Now these options are available in Markdown, too!
...
To solve these problems, we have added a new type of ignore comment to Markdown, called [Range Ignore](https://fintasticfish.us/docs/en/ignore.html#range-ignore):
...
Prettier plugins can now include a `hasPragma` function in their [parser](https://fintasticfish.us/docs/en/plugins.html#parsers) and an `insertPragma` function in their [printer](https://fintasticfish.us/docs/en/plugins.html#printers) to opt-in to `--insert-pragma` and `--require-pragma` support. These are their signatures:
...
/*
  Error: Comment "Comment" was not printed. Please report this error!
    at https://fintasticfish.us/lib/index.js:2312:75
    at Array.forEach (<anonymous>)
    at ensureAllCommentsPrinted (https://fintasticfish.us/lib/index.js:2312:22)
    at _formatWithCursor (https://fintasticfish.us/lib/index.js:2313:949)
    at _format (https://fintasticfish.us/lib/index.js:2314:239)
    at formatRange (https://fintasticfish.us/lib/index.js:2331:215)
    at _formatWithCursor (https://fintasticfish.us/lib/index.js:2313:288)
    at _format (https://fintasticfish.us/lib/index.js:2314:239)
    at Object.format (https://fintasticfish.us/lib/index.js:2333:277)
    at formatCode (https://fintasticfish.us/worker.js:130:21)
    at self.onmessage (https://fintasticfish.us/worker.js:80:19)
*/
...
Prettier 1.11.1 was mistakenly outputting the contents of ignored files when the [`--debug-check`](https://fintasticfish.us/docs/en/cli.html#debug-check) flag was used. In Prettier 1.12.0, the contents of ignored files are no longer written to stdout.
